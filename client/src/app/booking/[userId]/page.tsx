          ...
          <div className="flex flex-col lg:flex-row gap-6 md:gap-8 h-full">
            ...
            <div className="flex-1 lg:w-1/2">
              ...
              {bookingHistory.length > 0 ? (
                <div className="max-h-[400px] lg:max-h-[calc(100vh-200px)] overflow-y-auto space-y-4 pr-2">
                ...
                <div className="bg-white border border-gray-200 p-8 rounded-lg shadow-md text-center">
                  <p className="text-gray-500">
                    No booking history found with this provider.
                  </p>
                </div>
              )}
            </div>
