    ...
    <div className="min-h-screen flex flex-col bg-black text-white">
      ...
      <div className="flex-grow container mx-auto px-4 py-8">
        ...
        <div className="max-w-2xl mx-auto bg-gray-800 p-8 rounded-lg shadow-lg">
          <h1 className="text-3xl font-bold mb-6 text-center">Provider Profile</h1>
          <form onSubmit={handleSubmit}>
            ...
            <div className="mb-4">
              ...
              <input
                ...
                value={profile.email}
                readOnly
                className="w-full p-3 border rounded-md bg-gray-600 text-white"
              />
            </div>
            <div className="mb-4">
              <label htmlFor="profilePicture" className="block mb-2 text-lg font-semibold">Profile Picture</label>
              <input
                type="file"
                id="profilePicture"
                name="profilePicture"
            ...
            <div className="mb-4">
              <label htmlFor="address" className="block mb-2 text-lg font-semibold">Address</label>
              <input
                type="text"
                id="address"
                name="address"
            ...
            <div className="mb-4">
              <label htmlFor="workType" className="block mb-2 text-lg font-semibold">Work Type</label>
              <select
                id="workType"
                name="workType"
