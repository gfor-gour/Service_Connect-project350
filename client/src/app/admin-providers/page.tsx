      ...
      <div className={`w-full transition-all duration-300 ${sidebarExpanded ? "md:ml-64" : "md:ml-14"} p-4 md:p-8`}>
        <div className="mb-6 md:mb-8">
          <div className="flex items-center space-x-3 mb-2">
            ...
            <div>
              <h1 className="text-xl md:text-2xl font-bold text-gray-900">Manage Providers</h1>
        ...
        <Card>
          <CardHeader>
            <CardTitle className="text-lg md:text-xl">All Providers ({users.filter((user) => user.role === "provider").length})</CardTitle>
          </CardHeader>
